...
def reference_mechinsim():
    ...
    user1_shared_key = user1_private_key.exchange(x25519.X25519PublicKey.from_public_bytes(user2_public_key))
    user1_shared_key_hex = user1_shared_key.hex()

    # User2 computes shared secret key
    user2_shared_key = user2_private_key.exchange(x25519.X25519PublicKey.from_public_bytes(user1_public_key))
...
def get_Shared_Key(private_key_hex, public_key_hex):
    ...
    bytes_shared_key = private_key.exchange(x25519.X25519PublicKey.from_public_bytes(bytes_public_key))
